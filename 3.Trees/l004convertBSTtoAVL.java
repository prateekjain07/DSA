...
public class l004convertBSTtoAVL{
    ...
    public static TreeNode rightRotation(TreeNode A) { // for LL -> O(1)
        ...
        B.right = getRotation(A); // Must update A before  B
        return getRotation(B); // since A is below B now
    ...
    public static TreeNode leftRotation(TreeNode A) { // for RR  -> O(1)
        ...
        B.left = getRotation(A); //More generalised way
        return getRotation(B);// to handle the AVL tree
